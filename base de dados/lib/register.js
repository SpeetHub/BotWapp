...
const _registro = JSON.parse(fs.readFileSync('./base de dados/registro/registro.json'))
...
const addRegisteredUser = (userid, sender, time, serials) => {
            ...
            _registro.push(obj)
            fs.writeFileSync('./base de dados/registro/registro.json', JSON.stringify(_registro))
        }
