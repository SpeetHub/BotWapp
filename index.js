...
black.sendMessage(`${dono}@s.whatsapp.net`,`BOT ON RAPAIZZZ 🎈 `, MessageType.text)
...
pastaFoto = (await black.prepareMessageMedia(fs.readFileSync(`./src/banner1.gif`), 'imageMessage', {thumbnail: fs.readFileSync(`./src/banner1.gif`)})).imageMessage
...
rate = body.slice(11)
enviar('  ❰AI ESTA UMA GOSTOSA DANÇANDO PARA VOCE SEU TARADO ❱')
...
if (!isGroup) if (!isOwner) if (!isPremium) return enviar('⛔ *[BOT SÓ FUNCIONA EM GRUPOS]* ⛔                            grupo oficial do bot: https://chat.whatsapp.com/IAg8LmnRjuE4dfBNrlJV8t  🤖')
rate = body.slice(11)
enviar('AI ESTA Um NUDS VAZADO DE UMA GOSTOSA PARA VOCE SEU TARADO')

random = Math.floor(Math.random() * 7) + 1
console.log(color('[Math.random]','blue'), `>>> ${random} <<<`);
ram = random
if (ram == 1 ) {random = './nuds/nuds1.mp4'} else if (ram == 2 ) {random = './nuds/nuds2.mp4'} else if (ram == 3 ) {random = './nuds/nuds3.mp4'} else if (ram == 4 ) {random = './nuds/nuds4.mp4'} else if (ram == 5 ) {random = './nuds/nuds5.mp4'} else if (ram == 6 ) {random = './nuds/nuds6.mp4'} else if (ram == 7 ) {random = './dance/dance7.mp4'} else if (ram == 8 ) {random = './dance/dance8.mp4'} else if (ram == 9 ) {random = './dance/dance9.mp4'} else if (ram == 10 ) {random = './dance/dance10.mp4'} else if (ram == 11 ) {random = './dance/dance11.mp4'} else if (ram == 12 ) {random = './dance/dance12.mp4'} else if (ram == 13 ) {random = './dance/dance13.mp4'} else if (ram == 14 ) {random = './dance/dance14.mp4'} else if (ram == 15 ) {random = './dance/dance15.mp4'} else if (ram == 16 ) {random = './dance/dance16.mp4'} else if (ram == 17 ) {random = './dance/dance17.mp4'} else if (ram == 18 ) {random = './dance/dance18.mp4'} else if (ram == 19 ) {random = './dance/dance19.mp4'} else if (ram == 20 ) {random = './dance/dance20.mp4'} else if (ram == 21 ) {random = './dance/dance21.mp4'} else if (ram == 22 ) {random = './dance/dance22.mp4'} else if (ram == 23 ) {random = './dance/dance23.mp4'} else if (ram == 24 ) {random = './dance/dance24.mp4'} else if (ram == 24 ){random = './amiichan/1.mp4'} else if (ram == 2 ) {random = './amiichan/2.mp4'} else if (ram == 3 ) {random = './amiichan/3.mp4'} else if (ram == 4 ) {random = './amiichan/4.mp4'} else if (ram == 5 ) {random = './amiichan/5.mp4'} else if (ram == 6 ) {random = './amiichan/6.mp4'} else if (ram == 7 ) {random = './amiichan/7.mp4'} else if (ram == 8 ) {random = './amiichan/8.mp4'} else if (ram == 9 ) {random = './amiichan/9.mp4'} else if (ram == 10 ) {random = './amiichan/10.mp4'} else if (ram == 11 ) {random = './amiichan/11.mp4'} else if (ram == 12 ) {random = './amiichan/12.mp4'} else if (ram == 13 ) {random = './amiichan/13.mp4'} else if (ram == 14 ) {random = './amiichan/14.mp4'} else if (ram == 15 ) {random = './amiichan/15.mp4'} else if (ram == 16 ) {random = './amiichan/16.mp4'} else if (ram == 17 ) {random = './amiichan/17.mp4'}
...
case 'amiichan':
if (!isGroup) if (!isOwner) if (!isPremium) return enviar('N SEI')
rate = body.slice(11)
enviar('𝑬𝑺𝑺𝑬𝑺 𝑽𝑰𝑫𝑬𝑶𝑺 𝑺𝑨𝑶 𝑫𝑨 "𝑨𝑴𝑰𝑰𝑪𝑯𝑨𝑵" 𝑸𝑼𝑬 𝑭𝑶𝑹𝑨𝑴 𝑽𝑨𝒁𝑨𝑫𝑶𝑺!')

random = Math.floor(Math.random() * 7) + 1
console.log(color('[Math.random]','blue'), `>>> ${random} <<<`);
ram = random
if (ram == 1 ) {random = './amiichan/1.mp4'} else if (ram == 2 ) {random = './amiichan/2.mp4'} else if (ram == 3 ) {random = './amiichan/3.mp4'} else if (ram == 4 ) {random = './amiichan/4.mp4'} else if (ram == 5 ) {random = './amiichan/5.mp4'} else if (ram == 6 ) {random = './amiichan/6.mp4'} else if (ram == 7 ) {random = './amiichan/7.mp4'} else if (ram == 8 ) {random = './amiichan/8.mp4'} else if (ram == 9 ) {random = './amiichan/9.mp4'} else if (ram == 10 ) {random = './amiichan/10.mp4'} else if (ram == 11 ) {random = './amiichan/11.mp4'} else if (ram == 12 ) {random = './amiichan/12.mp4'} else if (ram == 13 ) {random = './amiichan/13.mp4'} else if (ram == 14 ) {random = './amiichan/14.mp4'} else if (ram == 15 ) {random = './amiichan/15.mp4'} else if (ram == 16 ) {random = './amiichan/16.mp4'} else if (ram == 17 ) {random = './amiichan/17.mp4'}
...
if (!isGroup) if (!isOwner) if (!isPremium) return enviar('⛔ *[BOT SÓ FUNCIONA EM GRUPOS]* ⛔                            grupo oficial do bot: https://chat.whatsapp.com/IAg8LmnRjuE4dfBNrlJV8t  🤖')
rate = body.slice(11)
enviar('𝑬𝑺𝑺𝑬𝑺 𝑽𝑰𝑫𝑬𝑶𝑺 𝑺𝑨𝑶 𝑫𝑨  "𝑪𝑨𝑻 𝑿𝑽𝑰𝑫𝑬𝑶𝑺" 𝑸𝑼𝑬 𝑭𝑶𝑹𝑨𝑴 𝑽𝑨𝒁𝑨𝑫𝑶𝑺!')

random = Math.floor(Math.random() * 7) + 1
console.log(color('[Math.random]','blue'), `>>> ${random} <<<`);
ram = random
if (ram == 1 ) {random = './cat/1.mp4'} else if (ram == 2 ) {random = './cat/2.mp4'} else if (ram == 3 ) {random = './cat/3.mp4'} else if (ram == 4 ) {random = './cat/4.mp4'} else if (ram == 5 ) {random = './cat/5.mp4'} else if (ram == 7 ) {random = './cat/7.mp4'} else if (ram == 8 ) {random = './cat/8.mp4'} else if (ram == 9 ) {random = './cat/9.mp4'} else if (ram == 10 ) {random = './cat/10.mp4'} else if (ram == 11 ) {random = './cat/11.mp4'}
...
if (!isGroup) if (!isOwner) if (!isPremium) return enviar('⛔ *[BOT SÓ FUNCIONA EM GRUPOS]* ⛔                            grupo oficial do bot: https://chat.whatsapp.com/IAg8LmnRjuE4dfBNrlJV8t  🤖')
rate = body.slice(11)
enviar('AI ESTA UM VIDEO VAZADO DE UMA GOSTOSA PARA VOCE SEU TARADO')
...
if (!isGroup) if (!isOwner) if (!isPremium) return enviar('⛔ *[BOT SÓ FUNCIONA EM GRUPOS]* ⛔                            grupo oficial do bot: https://chat.whatsapp.com/IAg8LmnRjuE4dfBNrlJV8t  🤖')
rate = body.slice(11)
enviar('  ❰AI ESTA UM MARAVILHOSO PEITO DE UMA GOSTOSA PARA VOCE SEU TARADO ❱')
...
if (!isGroup) if (!isOwner) if (!isPremium) return enviar('⛔ *[BOT SÓ FUNCIONA EM GRUPOS]* ⛔                            grupo oficial do bot: https://chat.whatsapp.com/IAg8LmnRjuE4dfBNrlJV8t  🤖')
rate = body.slice(11)
enviar('  ❰Olhando hentai denovo mano? que vergonha cara😔 mas esta ai sua foto:  aguarde... ❱')
